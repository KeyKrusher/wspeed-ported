...
static by*z=(by*)"_.X7JI.-67e':b5&+'&67&&:*&&+'&67&&:*&&+'&67&&:*Fbd'0`UOWV+c"
"=U>^Hd)N^E+))=ZE&+ea]>^HdQU.&,1@2&WVHG1(&VH&).2B>^UV+c-6Wed_+TNeF*)=ZE`<G1`5"
"CRV+cMT<^Hd9U^_M](=ZE`+=@d>^HdQU>LY14e@e&+c]J;0Q6+cUD:PN6+cUd9PM6+cUT80K6+cU"
"DWM':b3&+E&6W-&:b'&+E&6W-&:b'T8OJ(;Ze`+ETL;LHdA=/K8.K2+c]490L62?0`UCM:4GBX:Z"
"Ea+5eb9PM65?0`UCO:8GJX:ZEa+E.1A(P2:?N(>LW2J?PX>K_0)8LB2P><VVDO_HEKe067eO1L]3"
"UCDa&\\'R)R+e2TAbRZKO?9U+d2RA^RRK??YT+c2PAZRJK/?9T+b2NAVRBK_>YS+a2LARR:KO>9S"
"+`2JA.]&+c]Q;JHd95087eOe*ONeZ;H:ZE`+E,6W]&:b'&+E&6W-&:b'&+E&6W-^0+ONeZ1dbPHM"
"2M/87eOa*ONeZ1Dd_H52U^;Y1d6_e",o[256],w[256][64],NN[8],s[5][65536],l[299999],
...
G(int n){while((k=1<<n)>p)d+=(((*z++^255)-154)
...
int main(int C,char**V)
{
	...
	{	if(isatty(fileno(fo=stdout)))fo=fopen(A=OF?"/dev/dsp":
		"/dev/audio","rb+");if(!fo){perror(A);exit(-1);}a=c=i=sn[29]=0;
	...
	*++A=='r'?gn(),0:*A=='d'?OF=1:*A=='h'?h=1:0;else In="*stdin";
	...
	{	fprintf(stderr,"%s\n\nUsage:\t nesplay [options] nesfile.s3m\n"
		...
		"-b -m -r 22050\nOptions:\n"
			...
			"\t -h\tThis help\n",Title);if(h)exit(0);
		for(r=1280,LS=128,c=4;c--;)for(a=0;a<r;)if((S=G(7))-58)
